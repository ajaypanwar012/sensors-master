...
class Accelerometer extends StatefulWidget {
  @override
  AccelerometerState createState() => AccelerometerState();
}

class AccelerometerState extends State<Accelerometer> {
  // color of the circle
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          SizedBox(height: 10,),
          Text('Potholes count: $final_count'),
          SizedBox(height: 15,),
          Padding(
